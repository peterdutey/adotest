...
capture gethash using "test/suite1/TC0026/I don't exist.txt"
test_assert _rc == 601, message("gethash raises error when file does not exist")

gethash using "test/suite1/TC0026/error-from-stderr.txt"
