...
// Test when have quotes in expression
decode agegrp, gen(agestring)
test_console using "test/suite1/TC0027/expected_table1_string.txt", exp(table agestring if agestring != "40–49") 
